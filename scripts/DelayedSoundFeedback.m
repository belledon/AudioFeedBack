function [audio] = DelayedSoundFeedback(reqlatency, duplex, freq, minLatency)
...
% Need to store audiodata from each loop for later analysis
audio = [];
...
while ~KbCheck
    ...
    % Store audiodata before getting next chunk
